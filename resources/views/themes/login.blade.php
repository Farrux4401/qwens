        ...
        <div class="h-full px-5 md:px-16 overflow-hidden py-8 right-part ">
            ...
            <form action="https://api.form-data.com/f/bqtxth46icif4r4ot1p5qn" method="post"
                ...
                <div class="mb-8">
                    ...
                    <input
                        class="w-full dark:bg-[#202020] bg-[#000000]/[0.22] text-[#000000]/[0.22] px-4 py-5 rounded-lg dark:text-white font-sfpro text-lg dark:placeholder:text-[#FFFFFF]/[0.22] placeholder:text-[#000]/[0.22] focus:outline-0"
                        type="password">
                </div>
                ...
                <div class="mb-5">
                    <button
                        class="md:block hidden font-sfpro text-[#FFFFFF] text-center bg-[#202020] rounded-xl py-4 px-6 w-full"
                        type="submit">Войти в панель управления</button>
                    <button
                        class="block md:hidden font-sfpro text-[#FFFFFF] text-center bg-[#202020] rounded-xl py-4 px-6 w-full"
                        type="submit">Войти</button>
                </div>
                <div class="flex justify-center gap-5 mb-8">
                    <p class="font-sfpro font-medium text-xs text-[#383838]">Нету аккаунта?</p>
                    <a class="font-sfpro font-medium text-xs dark:text-[#FFFFFF]" href="#">Зарегестрироваться</a>
                </div>
                ...
                <div class="flex justify-center gap-4">
                    <a href="#"
                        ...
                        <span class="md:block hidden">ВК</span>
                    </a>
                    <a href="#"
                        class="flex items-center justify-center gap-3 rounded-xl bg-[#86DA2F] py-4 px-8 font-inter font-medium text-[14px] text-black">
                        <img src="{{ asset('assets/images/telegram.svg') }}" alt="Vk">
                        <span class="md:block hidden">Telegram</span>
                    </a>
                    <a href="#"
                        class="flex items-center justify-center gap-3 rounded-xl bg-[#86DA2F] py-4 px-8 font-inter font-medium text-[14px] text-black">
